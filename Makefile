...
help:
	...
	@echo "  make kalshi-sports-historical-consensus-archive — Acquire bounded paid historical no-vig snapshots"
	@echo "  make kalshi-sports-historical-consensus-feasibility — Check historical consensus skew and paid-access gate"
	@echo "  make kalshi-sports-historical-consensus-backfill — Replay historical no-vig consensus into FDR"
...
TYPE2_REFERENCE_BUILD_ODDS_RAW ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/odds_api/baseball_mlb_current_20260620T225933Z.json
TYPE2_REFERENCE_BUILD_ODDS_META ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/odds_api/baseball_mlb_current_20260620T225933Z.meta.json
TYPE2_REFERENCE_BUILD_KALSHI_JSON ?= data/kalshi_mlb_game_series_live_current_20260620T230203Z.json
TYPE2_REFERENCE_BUILD_REFERENCE_JSON ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/predmarket/type2-sportsbook-reference.json
...
TYPE2_DISPOSITION_SPORTSBOOK_JSON ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/predmarket/type2-sportsbook-reference.json
...
KALSHI_SPORTS_CONSENSUS_JSON ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/predmarket/sports-no-vig-consensus.json
KALSHI_SPORTS_CONSENSUS_KALSHI_JSON ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/predmarket/sports-consensus-kalshi-snapshot.json
...
KALSHI_SPORTS_CONSENSUS_ATP_BOOK_JSONL ?= $(PREDMARKET_PROJECTS_ROOT)/atp-oracle/data/sports/books/the-odds-api-atp-wimbledon-sharp-20260704T234540Z.jsonl
KALSHI_SPORTS_CONSENSUS_ATP_KALSHI_JSONL ?= $(PREDMARKET_PROJECTS_ROOT)/atp-oracle/data/sports/kalshi/kalshi-atp-wimbledon-20260704T234559Z.jsonl
...
KALSHI_SPORTS_CONSENSUS_NFL_KALSHI_JSON ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi/kalshi_nfl_game_series_latest.json
...
KALSHI_SPORTS_CONSENSUS_SOCCER_KALSHI_JSON ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi/kalshi_world_cup_game_series_latest.json
...
KALSHI_SPORTS_CONSENSUS_KEY_FILE ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/secrets/the_odds_api_key.txt
KALSHI_SPORTS_CONSENSUS_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/odds_api
...
KALSHI_SPORTS_CONSENSUS_SHARP_PROVIDER_PROBE_JSON ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/predmarket/sports-sharp-provider-probe-consensus.json
...
KALSHI_SPORTS_CONSENSUS_FALSIFICATION_OBSERVATION_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_consensus_observations
KALSHI_SPORTS_CONSENSUS_FALSIFICATION_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_consensus_labels
KALSHI_RESOLVED_ARCHIVE_BACKFILL_OUT_DIR ?= docs/codex/macro/kalshi-resolved-archive-backfill-latest
KALSHI_RESOLVED_ARCHIVE_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_resolved_archive_backfill
KALSHI_RESOLVED_ARCHIVE_MARKETS_RAW_PATH ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_resolved_archive_backfill/kalshi_resolved_archive_markets_latest.json
KALSHI_RESOLVED_ARCHIVE_CANDLESTICKS_RAW_PATH ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_resolved_archive_backfill/kalshi_resolved_archive_candlesticks_latest.json
...
KALSHI_SPORTS_HISTORICAL_CONSENSUS_ARCHIVE_OUT_DIR ?= docs/codex/macro/kalshi-sports-historical-consensus-archive-latest
KALSHI_SPORTS_HISTORICAL_CONSENSUS_BACKFILL_OUT_DIR ?= docs/codex/macro/kalshi-sports-historical-consensus-backfill-latest
KALSHI_SPORTS_HISTORICAL_CONSENSUS_ROWS_PATH ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_historical_consensus/kalshi_sports_historical_consensus_latest.json
KALSHI_SPORTS_HISTORICAL_CONSENSUS_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_historical_consensus/raw
KALSHI_SPORTS_HISTORICAL_CONSENSUS_BOOKMAKERS ?= pinnacle,circa,bookmaker,betcris,betfair_ex_uk,matchbook,smarkets
KALSHI_SPORTS_HISTORICAL_CONSENSUS_MIN_BOOKS ?= 2
KALSHI_SPORTS_HISTORICAL_CONSENSUS_PREGAME_LEAD_SECONDS ?= 3600
KALSHI_SPORTS_HISTORICAL_CONSENSUS_MAX_SNAPSHOTS ?= 0
KALSHI_SPORTS_HISTORICAL_CONSENSUS_MAX_PAID_CREDITS ?= 3000
KALSHI_SPORTS_HISTORICAL_CONSENSUS_CAPTURE ?= 0
...
KALSHI_SPORTS_CONSENSUS_OBSERVATION_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_consensus_observations
KALSHI_SPORTS_CONSENSUS_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_consensus_labels
KALSHI_SPORTS_CONSENSUS_SETTLED_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_consensus_settlements
KALSHI_SPORTS_CONSENSUS_SETTLED_SNAPSHOT ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_consensus_settlements/kalshi_sports_consensus_observed_markets_latest.json
...
KALSHI_EV_NFL_FAIR_LINE_REVIEW_PATH ?= $(PREDMARKET_PROJECTS_ROOT)/nfl_quant_glm51_greenfield/docs/codex/artifacts/nfl-line-readiness-latest/fair-line-review.json
...
KALSHI_EXTERNAL_ARTIFACT_WRAP_ROOT ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/predmarket_external_artifacts
...
KALSHI_PAPER_SETTLEMENT_SNAPSHOT ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_paper_settlements/kalshi_paper_observed_markets_latest.json
KALSHI_PAPER_SETTLEMENT_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_paper_settlements
...
KALSHI_ALWAYS_ON_COLLECTOR_TARGETS ?= line_moves,ticks,sports_consensus,sports,crypto
...
KALSHI_ALWAYS_ON_COLLECTOR_COMMAND_TIMEOUT_SECONDS ?= 600
...
KALSHI_MANUAL_DROP_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi
KALSHI_MANUAL_DROP_LATEST ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi/kalshi_mlb_game_series_latest.json
...
KALSHI_UNIVERSE_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_universe
KALSHI_UNIVERSE_LATEST_RAW ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_universe/kalshi_universe_scan_latest.json
...
KALSHI_LABELED_OBSERVATION_PENDING_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_oos_pending
KALSHI_LABELED_OBSERVATION_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_oos_labels
KALSHI_LABELED_OBSERVATION_SETTLED_SNAPSHOT ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_oos_settlements/kalshi_settled_markets_latest.json
KALSHI_LABELED_OBSERVATION_SETTLED_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_oos_settlements
...
KALSHI_LABELED_OOS_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_oos_labels
...
KALSHI_PROBABILITY_BREADTH_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_probability_sources
...
KALSHI_CRYPTO_PROXY_FEATURE_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_crypto_proxy_features
KALSHI_CRYPTO_PROXY_FEATURE_RAW_UNIVERSE ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_universe/kalshi_universe_scan_latest.json
KALSHI_SPORTS_PROXY_FEATURE_OUT_DIR ?= docs/codex/macro/kalshi-sports-proxy-feature-packet-latest
KALSHI_SPORTS_PROXY_FEATURE_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_proxy_features
KALSHI_SPORTS_PROXY_FEATURE_RAW_UNIVERSE ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_universe/kalshi_universe_scan_latest.json
KALSHI_SPORTS_PROXY_FEATURE_MLB_PLATFORM_MODEL ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/mlb_platform_signal_features/mlb_platform_sports_model_latest.json
...
KALSHI_CRYPTO_PROXY_OBSERVATION_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_crypto_proxy_observations
KALSHI_CRYPTO_PROXY_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_crypto_proxy_labels
KALSHI_CRYPTO_PROXY_SETTLED_SNAPSHOT ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_oos_settlements/kalshi_settled_markets_latest.json
KALSHI_CRYPTO_PROXY_SETTLED_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_oos_settlements
...
KALSHI_SPORTS_PROXY_OBSERVATION_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_proxy_observations
KALSHI_SPORTS_PROXY_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_proxy_labels
KALSHI_SPORTS_PROXY_SETTLED_SNAPSHOT ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_settlements/kalshi_settled_markets_latest.json
KALSHI_SPORTS_PROXY_SETTLED_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_settlements
...
KALSHI_ATP_PROXY_MATCH_SNAPSHOT ?= $(lastword $(sort $(wildcard $(PREDMARKET_PROJECTS_ROOT)/atp-oracle/data/kalshi/matches-*.json)))
KALSHI_ATP_PROXY_OBSERVATION_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_atp_proxy_observations
KALSHI_ATP_PROXY_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_atp_proxy_labels
KALSHI_ATP_PROXY_SETTLED_SNAPSHOT ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_atp_settlements/kalshi_atp_settled_markets_latest.json
KALSHI_ATP_PROXY_SETTLED_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_atp_settlements
...
KALSHI_ATP_PROXY_FORWARD_OOS ?= $(PREDMARKET_PROJECTS_ROOT)/atp-oracle/docs/codex/artifacts/kalshi-forward-oos-latest/report.json
KALSHI_ATP_PROXY_LIQUIDITY ?= $(PREDMARKET_PROJECTS_ROOT)/atp-oracle/docs/codex/artifacts/kalshi-forward-oos-liquidity-latest/liquidity.json
KALSHI_ATP_PROXY_BETTABLE_GATE ?= $(PREDMARKET_PROJECTS_ROOT)/atp-oracle/docs/codex/artifacts/kalshi-bettable-line-gate-latest/bettable-line-gate.json
KALSHI_ATP_PROXY_PRICE_OBSERVATIONS ?= $(PREDMARKET_PROJECTS_ROOT)/atp-oracle/docs/codex/artifacts/kalshi-forward-oos-price-observations-latest/prices.json
...
KALSHI_WORLD_CUP_PROXY_OBSERVATION_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_world_cup_proxy_observations
KALSHI_WORLD_CUP_PROXY_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_world_cup_proxy_labels
KALSHI_WORLD_CUP_PROXY_SETTLED_SNAPSHOT ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_world_cup_settlements/kalshi_observed_markets_latest.json
KALSHI_WORLD_CUP_PROXY_SETTLED_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_world_cup_settlements
...
KALSHI_SPORTS_MICROSTRUCTURE_RAW_ORDERBOOK_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_microstructure_orderbooks
KALSHI_SPORTS_MICROSTRUCTURE_OBSERVATION_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_microstructure_observations
KALSHI_SPORTS_MICROSTRUCTURE_SETTLED_SNAPSHOT ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_microstructure_settlements/kalshi_sports_microstructure_observed_markets_latest.json
KALSHI_SPORTS_MICROSTRUCTURE_SETTLED_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_microstructure_settlements
KALSHI_SPORTS_MICROSTRUCTURE_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_microstructure_labels
KALSHI_SPORTS_LINE_MOVE_OUT_DIR ?= docs/codex/macro/kalshi-sports-line-move-delta-logger-latest
KALSHI_SPORTS_LINE_MOVE_STATE_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_line_moves
...
KALSHI_SPORTS_EXECUTABLE_HORIZON_OUT_DIR ?= docs/codex/macro/kalshi-sports-executable-horizon-research-latest
KALSHI_SPORTS_EXECUTABLE_HORIZON_OBSERVATION_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_microstructure_observations
KALSHI_SPORTS_EXECUTABLE_HORIZON_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_microstructure_labels
KALSHI_SPORTS_EXECUTABLE_HORIZON_TICK_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_ticks
KALSHI_SPORTS_EXECUTABLE_HORIZON_EXPORT_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_executable_horizon_labels
...
KALSHI_TICK_RECORDER_ROTATE_BYTES ?= 250000000
...
KALSHI_NEAR_RESOLUTION_FLOW_TERMS_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi
...
KALSHI_PASSIVE_LIQUIDITY_PAPER_FILL_STATE_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_passive_liquidity_paper_fills
...
KALSHI_SPORTS_BLOCKER_CLEARANCE_ATP_REPO ?= $(PREDMARKET_PROJECTS_ROOT)/atp-oracle
...
KALSHI_CRYPTO_PROXY_MODEL_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_crypto_proxy_labels
...
KALSHI_CRYPTO_PROXY_REPLAY_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_crypto_proxy_labels
...
KALSHI_SPORTS_PROXY_CCD_RAW_ORDERBOOK_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_sports_proxy_orderbooks
...
KALSHI_WEATHER_PROXY_FEATURE_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_weather_proxy_features
KALSHI_WEATHER_PROXY_FEATURE_RAW_UNIVERSE ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_universe/kalshi_universe_scan_latest.json
...
KALSHI_WEATHER_PROXY_OBSERVATION_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_weather_proxy_observations
KALSHI_WEATHER_PROXY_LABEL_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_weather_proxy_labels
KALSHI_WEATHER_PROXY_SETTLED_SNAPSHOT ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_weather_proxy_settlements/kalshi_weather_settled_markets_latest.json
KALSHI_WEATHER_PROXY_SETTLED_RAW_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_weather_proxy_settlements
...
KALSHI_WEATHER_PROXY_CCD_RAW_ORDERBOOK_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_weather_proxy_orderbooks
...
KALSHI_CRYPTO_PROXY_CCD_RAW_ORDERBOOK_DIR ?= $(PREDMARKET_MANUAL_DROPS_ROOT)/kalshi_crypto_proxy_orderbooks
...
kalshi-sports-historical-consensus-archive:
	@python3 scripts/kalshi_sports_historical_consensus_archive.py \
		--write \
		--out-dir $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_ARCHIVE_OUT_DIR) \
		--archive-path $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_ROWS_PATH) \
		--raw-dir $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_RAW_DIR) \
		--markets-raw-path $(KALSHI_RESOLVED_ARCHIVE_MARKETS_RAW_PATH) \
		--candlesticks-raw-path $(KALSHI_RESOLVED_ARCHIVE_CANDLESTICKS_RAW_PATH) \
		--api-key-file "$(KALSHI_SPORTS_CONSENSUS_KEY_FILE)" \
		--bookmakers $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_BOOKMAKERS) \
		--min-distinct-books $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_MIN_BOOKS) \
		--pregame-lead-seconds $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_PREGAME_LEAD_SECONDS) \
		--snapshot-interval-seconds $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_SNAPSHOT_INTERVAL_SECONDS) \
		--max-skew-seconds $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_MAX_SKEW_SECONDS) \
		--max-snapshots $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_MAX_SNAPSHOTS) \
		--max-paid-credits $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_MAX_PAID_CREDITS) \
		$(if $(filter 1 true yes,$(KALSHI_SPORTS_HISTORICAL_CONSENSUS_CAPTURE)),--capture-paid,)
...
kalshi-sports-historical-consensus-backfill:
	@python3 scripts/kalshi_sports_historical_consensus_backfill.py \
		--write \
		--out-dir $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_BACKFILL_OUT_DIR) \
		--feasibility-path docs/codex/macro/latest-kalshi-sports-historical-consensus-feasibility.json \
		--historical-consensus-path $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_ROWS_PATH) \
		--markets-raw-path $(KALSHI_RESOLVED_ARCHIVE_MARKETS_RAW_PATH) \
		--candlesticks-raw-path $(KALSHI_RESOLVED_ARCHIVE_CANDLESTICKS_RAW_PATH) \
		--max-skew-seconds $(KALSHI_SPORTS_HISTORICAL_CONSENSUS_MAX_SKEW_SECONDS)
...
kalshi-sports-executable-horizon-research:
	@python3 scripts/kalshi_sports_executable_horizon_research.py \
		--write \
		--out-dir $(KALSHI_SPORTS_EXECUTABLE_HORIZON_OUT_DIR) \
		--observation-dir $(KALSHI_SPORTS_EXECUTABLE_HORIZON_OBSERVATION_DIR) \
		--label-dir $(KALSHI_SPORTS_EXECUTABLE_HORIZON_LABEL_DIR) \
		--tick-dir $(KALSHI_SPORTS_EXECUTABLE_HORIZON_TICK_DIR) \
		--export-label-dir $(KALSHI_SPORTS_EXECUTABLE_HORIZON_EXPORT_LABEL_DIR) \
...
kalshi-tick-recorder:
	@python3 scripts/kalshi_tick_recorder.py \
		...
		--rotate-bytes $(KALSHI_TICK_RECORDER_ROTATE_BYTES) \
...
kalshi-always-on-collector-once:
	@python3 scripts/kalshi_always_on_collector.py \
		...
		--command-timeout-seconds $(KALSHI_ALWAYS_ON_COLLECTOR_COMMAND_TIMEOUT_SECONDS) \
